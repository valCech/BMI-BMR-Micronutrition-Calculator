...
gender = str(input('If you are man type m otherwise type w\n'))
...
if gender == str('m' or 'M'):
  print("Hallo " + name + ' ' +'Your daily calorie intake should be ' + diet_calories_m + 'cal\n'
  ...
  print('Here is your micronutrient ratio:\n' + 'Protein:' + protein_m + 'g\n', 
       ...
       'Fat: ' + fat_m + 'g')
elif gender == str('w' or 'W'):
  print('Hallo ' + name +'Your daily calorie intake should be ' + diet_calories_w + 'cal\n'
